...
class ActivityManager private constructor() : ActivityLifecycleCallbacks {
    ...
    override fun onActivityCreated(activity: Activity , savedInstanceState: Bundle?) {
        DLogUtil.d("%s - onCreate" , activity.javaClass.simpleName)
        if (activitySet.size == 0) {
            ...
            DLogUtil.d("%s - onApplicationCreate" , activity.javaClass.simpleName)
        }
    ...
    override fun onActivityStarted(activity: Activity) {
        DLogUtil.d("%s - onStart" , activity.javaClass.simpleName)
    }

    override fun onActivityResumed(activity: Activity) {
        DLogUtil.d("%s - onResume" , activity.javaClass.simpleName)
        if (topActivity === activity && resumedActivity == null) {
            for (callback: ApplicationLifecycleCallback in lifecycleCallbacks) {
                callback.onApplicationForeground(activity)
            }
            DLogUtil.d("%s - onApplicationForeground" , activity.javaClass.simpleName)
        }
        topActivity = activity
    ...
    override fun onActivityPaused(activity: Activity) {
        DLogUtil.d("%s - onPause" , activity.javaClass.simpleName)
    }

    override fun onActivityStopped(activity: Activity) {
        DLogUtil.d("%s - onStop" , activity.javaClass.simpleName)
        ...
        if (resumedActivity == null) {
            ...
            DLogUtil.d("%s - onApplicationBackground" , activity.javaClass.simpleName)
        }
    }

    override fun onActivitySaveInstanceState(activity: Activity , outState: Bundle) {
        DLogUtil.d("%s - onSaveInstanceState" , activity.javaClass.simpleName)
    }

    override fun onActivityDestroyed(activity: Activity) {
        DLogUtil.d("%s - onDestroy" , activity.javaClass.simpleName)
        ...
        if (activitySet.size == 0) {
            ...
            DLogUtil.d("%s - onApplicationDestroy" , activity.javaClass.simpleName)
        }
    }
