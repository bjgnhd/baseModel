...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        // 文本粗体设置
        if (array.hasValue(R.styleable.SettingBar_bar_leftTextBold)) {
            boolean aBoolean = array.getBoolean(R.styleable.SettingBar_bar_leftTextBold, false);
            if (aBoolean) {
        ...
        // 图标显示的大小-宽高
        if (array.hasValue(R.styleable.SettingBar_bar_leftDrawableHeight) && array.hasValue(R.styleable.SettingBar_bar_leftDrawableWidth)) {
            setLeftDrawableSize(array.getDimensionPixelSize(R.styleable.SettingBar_bar_leftDrawableHeight, 0),
                    array.getDimensionPixelSize(R.styleable.SettingBar_bar_leftDrawableWidth, 0));
        }
        ...
        // 文字大小设置
        setLeftTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_leftTextSize, (int) getResources().getDimension(R.dimen.text_size_15)));
        setRightTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_rightTextSize, (int) getResources().getDimension(R.dimen.text_size_14)));
        ...
        if (array.hasValue(R.styleable.SettingBar_bar_enableClick)) {
            setEnableClick(array.getBoolean(R.styleable.SettingBar_bar_enableClick, true));
        }
     ...
     * 设置左边的图标大小
     */
    public SettingBar setLeftDrawableSize(int height, int width) {
    ...
    public SettingBar setEnableClick(boolean enableClick) {
